...
export default function AboutMe() {
    const firstParagraph: string = `My name is Adam Fesmire, and I'm currently seeking career opportunities in software engineering, 
    ...
    return (
        <main className="relative min-h-screen flex flex-col justify-center items-center">
            <div className="flex w-screen h-screen">
                <div className="bg-slate-800 m-20 text-white p-6 w-full h-3/5 border-2 border-slate-400 rounded-3xl">
                    <h1 className="text-5xl">About Me</h1>
                    <p className="mt-5 text-3xl">
                        <TypeWriter message={firstParagraph}/><br/>
                        <TypeWriter message={secondParagraph}/>
                    </p>
                </div>
            </div>
        </main>
